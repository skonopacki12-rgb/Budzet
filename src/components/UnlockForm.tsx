    ...
    <form action={formAction} className="flex flex-col gap-3">
      <label className="flex flex-col gap-1 text-sm text-neutral-700 dark:text-neutral-300">
        ...
        <input
          ...
          required
          placeholder="••••"
          className="rounded-lg border border-neutral-300 dark:border-neutral-700 px-3 py-3 text-center text-2xl tracking-[0.5em] outline-none focus:border-neutral-900 dark:focus:border-neutral-100"
        />
      </label>
